...
contract AbSwapXGnosis is OpsTaskCreator, IXReceiver {
        ...
        )
    {
        ...
        swapRouter.swapExactTokensForETHSupportingFeeOnTransferTokens(amountIn, 0, path, address(this), block.timestamp+3600); 

        uint256[] memory amountOut2 = swapRouter.getAmountsOut(amountIn, path);
        return amountOut2[0];
